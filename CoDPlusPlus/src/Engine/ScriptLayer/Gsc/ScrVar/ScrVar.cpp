...
void ScrVar::SetFunction(int32_t value) { Type = VarType::Function; Value = value; }
...
bool ScrVar::IsFunction() const { return Type == VarType::Function; }
...
int32_t ScrVar::GetFunction() const
{
...
ScrVar ScrVar::From(VariableValue* var)
{
	...
	case VarType::Function:
	{
		...
		scrVar.SetFunction(var->intValue - scrVarPub_programBuffer);
		break;
	}
	case VarType::Entity:
	{
